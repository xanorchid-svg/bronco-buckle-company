...
export default function TheBelt() {
  return (
    <div className="page inner-page">
      ...
      <div className="section container" style={{ background: 'rgba(148, 170, 222, 0.06)', margin: '0', maxWidth: '100%', padding: '5rem 2rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div className="section--steel two-col" style={{ padding: '3rem', marginBottom: '3rem', alignItems: 'center' }}>
            <div>
